...
Enhancements:
  ...
  * Added the ability to specify a file pathway for `distancesMatrix()` if the 'spatial.csv' is not in the main working directory. (issue [#133](https://github.com/hugomflavio/actel/issues/133))
