...
test_that("transformSpatial handles release site mismatches properly and delivers correct output when possible", {
	...
	expect_equal(output$release.sites$Station.name, factor("unspecified"))

	expect_equal(output$release.sites$Array, factor("River1"))
	...
	expect_equal(output$release.sites$Station.name, factor("RS1"))
	expect_equal(output$release.sites$Array, factor("River1"))
...
test_that("transformSpatial handles sections properly", {
	...
	expect_equal(output$array.order$all, c('River0', 'River1', 'River2', 'River3', 'River4', 'River5', 'River6', 'Fjord1', 'Fjord2', 'Sea1'))
	...
	expect_equal(output$array.order$River, c('River0', 'River1', 'River2', 'River3', 'River4', 'River5', 'River6'))
	expect_equal(output$array.order$Fjord, c('Fjord1', 'Fjord2'))
	expect_equal(output$array.order$Sea, c('Sea1'))
