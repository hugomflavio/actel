...
Release.date
  ...
  : Note that the timestamps must be in the **local time zone** of the study area, which you will later supply in the `tz.study.area` argument.
...
Start and Stop
  ...
  : Note that these time stamps **must** be in the local time zone of the study area, which you will later supply in the `tz.study.area` argument.
