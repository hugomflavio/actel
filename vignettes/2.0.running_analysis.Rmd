...
actel(path = NULL, sections, success.arrays, minimum.detections = 2, 
    ...
    exclude.tags = NULL, cautious.assignment = TRUE)
```
...
<img src="LaTeX_example_survival.svg" alt="drawing" width="330"/> <img src="LaTeX_example_progression.svg" alt="drawing" width="330"/>
