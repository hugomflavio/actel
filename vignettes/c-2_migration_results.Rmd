...
4. **Fish comparisons (Dotplots)**
  ...
  As the name suggests, this plot compares variables across all your fish: The total number of detections, and the time to/time in each of your study area sections. To simplify the visualisation, for each variable, the **top 10%** of the data is painted in **red**, and the **bottom 10%** of the data is painted in **blue**.
...
5. **Graphics of detected tags**
  ...
  Note that fish where you had to manually intervene during the analysis will be highlighted with a yellow border, and fish that were manually overridden through the [`override` argument](c-0_migration.html#override) will be highlighted with a red border.
