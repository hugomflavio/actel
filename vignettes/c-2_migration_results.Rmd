...
2. **Last seen arrays**
  ...
  This graphic compiles the information on where each fish was last seen. The information used for this graphic can be found in the `status.df` object, which is in your results in R (more specifically in the 'Very.last.array' column).
