...
```r
residency(tz, sections, success.arrays = NULL, max.interval = 60, minimum.detections = 2, 
  ...
  save.detections = FALSE, section.minimum = 2, replicates = NULL, GUI = c("needed", "always", "never"))
```
