...
By default, actel decides wether to plot the detections by station or by array, depending on the number of stations and arrays present in the study area. However, you can force a specific Y axis by setting `plot.detections.by` to either 'stations' or 'arrays'. Note that this will also affect the sensor data plots, as they are coloured consitently with the detection plots.
