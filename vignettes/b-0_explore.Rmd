...
By default, the detections are plotted using the standard station names. However, when you are working with many stations, this can make the detection plots particularly hard to disentangle. As such, you can set `plot.detections.by = 'arrays'` to use the study area's arrays as the y axis.
