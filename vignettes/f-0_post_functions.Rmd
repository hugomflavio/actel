...
Circular plots can do a great job at passing a point across in a publication, be it differences between groups or between arrival points at different places, or both. Although actel provides circular plots with its analyses, these default plots may not be exactly what you are looking for. As such, I created the function `plotTimes`, to help you get your plot just right.
