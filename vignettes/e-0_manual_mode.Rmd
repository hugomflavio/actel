...
vignette: >
  %\VignetteIndexEntry{5) Manual mode}
...
Note: You can select event ranges by separating them with a ':' and/or multiple events at once by separating them with a space.
Events to be rendered invalid: 
```

You must then select which events you would like to be invalidated. Once you have finished your edits, actel will automatically terminate manual mode and proceed with the analysis.
