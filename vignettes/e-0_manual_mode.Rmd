...
When this happens, it is time to take the lead and tell actel what you want to do, by triggering the manual processing mode. To do this, simply add the signals that you want to deal with manually in the `override` argument (e.g. `override = c(1234, 1405)`).
