...
It is at this point that the argument [`exclude.tags`]() comes in:
...
`maximum.time`
  : This argument controls the creation of multiple events for consecutive detections on the same receiver array. You can [find more information on this argument here](b-0_explore.html#maximum.time).
