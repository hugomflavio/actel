...
As you probably know by now, you can define unidirectional connections between arrays. This means that something (e.g. a weir or dam) prevents the fish from moving in a particular direction. Let's see the examples below, with arrays A, B and C:
