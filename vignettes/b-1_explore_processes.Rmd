...
`maximum.time`
  : This parameter controls the creation of multiple events for consecutive detections on the same receiver array. You can [find more information on this parameter here](b-0_explore.html#maximum.time).
