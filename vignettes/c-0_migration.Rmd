...
```r
migration(tz, sections, success.arrays = NULL, max.interval = 60, minimum.detections = 2, 
  ...
  auto.open = TRUE, save.detections = FALSE, if.last.skip.section = TRUE, replicates = NULL, 
  disregard.parallels = TRUE, GUI = c("needed", "always", "never"))
```
