...
migration(path = NULL, sections, success.arrays = NULL, minimum.detections = 2, 
  ...
  cautious.assignment = TRUE, replicates = NULL, disregard.parallels = TRUE, jump.warning = 2, 
  jump.error = 3, inactive.warning = NULL, inactive.error = NULL)
```
...
You can find more information on [how to operate full manual mode here](c-3_migration_manual_mode.html).
